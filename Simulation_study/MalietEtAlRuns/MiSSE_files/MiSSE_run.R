...
sessionInfo() 
future::plan(cluster, workers = cl)
cache_run_crashed2 <- drake::new_cache(path = "drake_cache_misse_on_clads_crashed2", hash_algorithm = "md5")
make(run_misse_on_clads_crashed, cache=cache_run_crashed2, parallelism="future", jobs=96)
parallel::stopCluster(cl)
